...
PrivateData = @{
    ...
    PSData = @{
        ...
        Tags = @('syslog', 'logging', 'log', 'linux', 'unix', 'logstash')
        ...
        ReleaseNotes = 'Resolves issues with PowerShellHostVersion in manifest as reported by powershellshock'
